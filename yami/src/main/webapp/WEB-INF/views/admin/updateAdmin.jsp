    ...
    <div class="row justify-content-center">
        <div class="col-md-10 col-lg-8">
            <div class="card shadow-lg mb-4">
                ...
                <div class="card-body">
                    <form id="adminSearchForm" class="row g-3 align-items-center">
                        <div class="col-auto">
                            ...
                            <label class="form-check-label me-3">
                                <input type="radio" class="form-check-input" name="select" value="super">
                                최고 관리자
                            </label>
                            <label class="form-check-label me-3">
                                <input type="radio" class="form-check-input" name="select" value="normal">
                                일반 관리자
                            </label>
                            <label class="form-check-label me-3">
...
<div class="modal fade" id="adminEditModal" tabindex="-1" aria-labelledby="adminEditModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <form id="adminEditForm" class="modal-content">
